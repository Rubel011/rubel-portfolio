...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn("data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 bg-black/50 backdrop-blur-sm duration-200 data-ending-style:opacity-0 data-starting-style:opacity-0 fixed inset-0 z-50", className)}
      {...props}
    />
  )
}
